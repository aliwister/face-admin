...
export const RefundFormDialog = ({open, onSubmit, onClose, payment}) =>{
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <TextField variant="filled" size="small" type="text" placeholder="Auth Code" name="authCode" value={payment.authCode} className={classes.textBox} inputRef={register({required: true, maxLength: 6})} />
      <FormControl variant="filled" size="small" className={classes.formControl}>
        <Select native name="method" inputRef={register({ required: true })} value={payment.paymentMethod}>
