...
export const PaymentFormDialog = ({open, onSubmit, onClose}) =>{
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <DialogContent>
      <TextField variant="filled" size="small" placeholder="Amount" name="amount" className={classes.textBox} inputRef={register({required: true, max: 1000, min: 1, maxLength: 5})} />
      <TextField variant="filled" size="small" type="text" placeholder="Auth Code" name="authCode" className={classes.textBox} inputRef={register({required: true, maxLength: 6})} />
