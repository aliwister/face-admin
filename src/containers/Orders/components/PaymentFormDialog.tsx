...
export const PaymentFormDialog = ({open, onSubmit, onClose}) =>{
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <DialogContent>
      <TextField variant="filled" size="small" placeholder="Amount" name="amount" className={classes.textBox} inputRef={register({required: true, max: 10000, min: .1, maxLength: 7})} />
